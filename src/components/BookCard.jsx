...
export default function BookCard({ book }) {
  const { id, book_name, author_name, price, availability, in_stock, image } = book;
      ...
      <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden h-full cursor-pointer transform hover:scale-105">
        ...
        <div className="relative w-full h-56 bg-gray-200 overflow-hidden">
          <img
            ...
            onError={(e) => {
              e.target.src = 'https://via.placeholder.com/300x400?text=' + encodeURIComponent(book_name);
            }}
          />
          {!in_stock && (
        ...
        <div className="p-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                if (in_stock) alert(`Added "${book_name}" to cart`);
              }}
            >
            ...
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                alert(`Added "${book_name}" to favorites`);
              }}
            >
